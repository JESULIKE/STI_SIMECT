        ...
        <form @submit.prevent="handleLogin" class="space-y-6 relative z-10">
          ...
          <div class="space-y-2">
            ...
            <input 
              ...
              required
              placeholder="••••••••"
              class="w-full px-6 py-5 bg-blue-50 border-2 border-blue-200 rounded-3xl text-blue-900 placeholder:text-blue-300 focus:border-blue-500 focus:outline-none transition-all shadow-sm tracking-tighter"
            >
          </div>
